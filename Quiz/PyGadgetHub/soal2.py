# buat fungsi filter_harga(data, min_harga, max_harga) yang mengembalikan list gadget yang harganya masuk dalam rentang tersebut
# jika tidak ada yang sesuai, kembalikan list kosong 
